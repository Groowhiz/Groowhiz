App.addChild('Talent', _.extend({
    el: 'body[data-action="show"][data-controller-name="talents"]',
    ...
    activate: function(){
        this.$warning = this.$('#talent_warning_text');
        this.$embed= this.$('#talent_embed');
        this.$container = $(".talent-about");
